    ...
    <div className="flex flex-col justify-center items-start p-4 mt-12 gap-4 md:items-center md:p-20 md:mt-0">
      ...
      <div>
        <div className="flex items-center gap-6 w-[300px]">
          ...
          <div className="text-xl border-b border-b-neutral-400 w-[300px] text-center cursor-none">
            Calendar Date
          </div>
        </div>
        <div className="flex gap-4 pt-6 pb-6 text-xl justify-between">
          <div className="flex gap-4 items-center">
            <button className="className= text-slate-600 text-2xl">
              <LuClock7 />
            </button>
            <div className="border-b border-b-neutral-400  text-center">
              17:00
            </div>
          </div>
          <div className="flex gap-4 items-center">
